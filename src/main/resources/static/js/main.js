...
function onConnected() {
  stompClient.subscribe('/user/queue/messages', onMessageReceived, (err) => {
  ...
  stompClient.send("/app/user.addUser",
      {},
      JSON.stringify({name: name, email: email, status: 'ONLINE'})
  );
...
function onLogout() {
  stompClient.send("/app/user.disconnectUser",
      {},
      JSON.stringify({name: name, email: email, status: 'OFFLINE'})
  );
